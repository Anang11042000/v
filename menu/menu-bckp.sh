...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/Anang11042000/userbackup.git
    git push -f https://github.com/Anang11042000/userbackup.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/Anang11042000/userbackup/main/$NameUser/$NameUser.zip"
sleep 1
...
cekdata=$(curl -sS https://raw.githubusercontent.com/Anang11042000/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
mkdir -p /root/backup
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/Anang11042000/userbackup/main/$NameUser/$NameUser.zip" &> /dev/null
