...
- name: Anangvpn-$user-WS (CDN) Non TLS
  type: vmess
  server: ${domain}
  port: 80
  uuid: ${uuid}
...
echo -e "Port TLS     : 443" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port NTLS    : 80, 8080, 2086" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port DNS     : 443, 53 " | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port GRPC    : 443" | tee -a /etc/Tarap-Kuhing/user.log
...
echo -e "Network      : WS or gRPC" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Path TLS     : (/multi path)/vmess " | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Path NLS     : (/multi path)/vmess " | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Path Dynamic : CF-XRAY:http://bug.com " | tee -a /etc/Tarap-Kuhing/user.log
echo -e "ServiceName  : vmess-grpc" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Link TLS     : ${vmesslink1}" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Link NTLS    : ${vmesslink2}" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Link GRPC    : ${vmesslink3}" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Link OPOK    : ${vmesslink4}" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Format OpenClash : https://${domain}:81/vmess-$user.txt" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
