...
Exp1=$(curl https://raw.githubusercontent.com/Anang11042000/Izin/main/Ip | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
    sts="${Info}"
else
    sts="${Error}"
...
echo -e " ${BICyan}┌─────────────────────────────────────────────────────┐${NC}"
echo -e " ${BICyan}│                  ${BIWhite}ANANG ${BIYellow}VPN ${BICyan}TUNNELING ${NC}"
echo -e " ${BICyan}│${NC}"
...
echo -e " ${BICyan}|    [${BIWhite}15${BICyan}] THEME  "
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e " ${BICyan}|    [${BIWhite}99${BICyan}] INSTALL SLOWDNS           ${NC} "
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
17) clear ; copy ;;
0) clear ; menu ;;
99) clear ; wget https://raw.githubusercontent.com/Anang11042000/v/main/wireguard/installsl.sh && chmod +x installsl.sh && ./installsl.sh ;;
x) exit ;;
