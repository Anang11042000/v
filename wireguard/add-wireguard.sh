#!/bin/bash
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Anang11042000/Izin/main/Ip > /root/tmp
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Anang11042000/Izin/main/Ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Anang11042000/Izin/main/Ip | grep $MYIP | awk '{print $3}')
fi
clear
...
====================================================================
             P R O J E C T  O F  A N A N G. V P N
                       [Freedom Internet]
====================================================================
====================================================================
...
echo -e "\e[42m      SSH OVPN Account     \E[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Username         : $LOGIN" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Password         : $PASSWD" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Expired          : $exp" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "IP               : $IP" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Host             : $domain" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Host Slowdns     : ${NS}" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Pub Key          : ${PUB}" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Location         : $CITY" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port OpenSSH     : 39" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port DNS         : 443, 53 ,22 " | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port Dropbear    : 109,143" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port Dropbear WS : 109,143" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port SSH WS      : 80 " | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port SSH SSL WS  : 443" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port SSL/TLS     : 443,1194" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port OVPN WS SSL : 443,1194" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port OVPN SSL    : 443,1194" | tee -a /etc/Tarap-Kuhingh/user.log
echo -e "Port OVPN TCP    : 443,1194" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Port OVPN UDP    : 2200" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "Proxy Squid      : 3128" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "BadVPN UDP       : 7100, 7300, 7300" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
...
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "OpenVPN WS SSL   : https://$domain:81/$domain-ws-ssl.ovpn" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "OpenVPN SSL      : https://$domain:81/$domain-ssl.ovpn" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "OpenVPN TCP      : https://$domain:81/$domain-tcp.ovpn" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "OpenVPN UDP      : https://$domain:81/$domain-udp.ovpn" | tee -a /etc/Tarap-Kuhing/user.log
echo -e "\033[1;93m───────────────────────────\033[0m" | tee -a /etc/Tarap-Kuhing/user.log
