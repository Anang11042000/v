...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/Anang11042000/Izin/main/Ip | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# ==================================================
# Link Hosting Kalian
tarapkuhing="raw.githubusercontent.com/Anang11042000/v/main/wireguard"
...
echo -e "${Info} Wireguard Script By Anang"
